...
CREATE TABLE IF NOT EXISTS app_user (
    ...
    img_path        VARCHAR(150), -- profile image path
    user_password   VARCHAR(255) NOT NULL,
    register_date   TIMESTAMPTZ    NOT NULL DEFAULT CURRENT_TIMESTAMP,
    country_id      INT,
    user_type       VARCHAR(50)  NOT NULL,
    user_status     VARCHAR(50)  NOT NULL, -- e.g. 'suspended', 'active'
...
CREATE TABLE IF NOT EXISTS transaction_list (
    ...
    payment_method      VARCHAR(100)   NOT NULL, -- 'credit-card', etc.
    payment_status      VARCHAR(100)   NOT NULL, -- 'Completed', 'Pending' , 'Refunded', 'Cancelled', etc.
...
CREATE TABLE IF NOT EXISTS reviews (
    ...
    post_status     VARCHAR(100)     NOT NULL, -- e.g. 'Hidden', 'published'
...
CREATE TABLE IF NOT EXISTS playlist (
    ...
    visibility    VARCHAR(100) NOT NULL, -- e.g. 'public', 'hidden', 'unlisted'
...
CREATE TABLE IF NOT EXISTS user_content (
    ...
    watch_status VARCHAR(100), -- e.g. 'Unwatched', 'Unfinished', 'Finished'
...
CREATE TABLE IF NOT EXISTS tv_show (
    ...
    curr_status  VARCHAR(100) NOT NULL, -- e.g. 'Not aired', 'Aired', 'Off', etc.
...
CREATE TABLE IF NOT EXISTS movie (
    content_id INT PRIMARY KEY,
    curr_status  VARCHAR(100) NOT NULL, -- e.g. 'Not released', 'Released', etc.
...
CREATE TABLE IF NOT EXISTS content_resource (
    ...
    lang_type   VARCHAR(50) NOT NULL, -- 'Audio', 'Subtitle'
    file_path   VARCHAR(255) NOT NULL,
    priority   INT NOT NULL DEFAULT 1,
